...
<div class="coaching" id="1on1">
    ...
    <div class="transitioning" id="transitioning">
        <div class="transitioning__content-wrapper">
            ...
            <img class="transitioning__img" src="<?php echo get_theme_file_uri('/images/professional.jpg') ?>"
                alt="A female professional standing at a desk with a computer smiling at the camera.">
        </div>
    </div>

    <!-- Leadership Development Section -->
    <div class=" section " id="leadership">
        <div class="section__content-wrapper section__content-wrapper--row-reverse">
            ...
            <img class="section__img" src="<?php echo get_theme_file_uri('/images/best-boss.jpg') ?>"
                alt="Two female professionals looking serious.">
        </div>
    </div>
</div>
