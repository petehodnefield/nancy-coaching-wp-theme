...
<!-- Hero section -->
<div class="hero ">
    <img class="hero__bg-image" src="<?php echo get_theme_file_uri('/images/hero-image.png') ?>" alt="A woman smiling at the camera in a room full of plants and sunlight.">
